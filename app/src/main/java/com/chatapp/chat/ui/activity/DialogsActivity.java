...
import com.chatapp.chat.utils.qb.callback.QbEntityCallbackImpl;
...
//                com.chatapp.chat.ui.activity.LoginActivity.start(DialogsActivity.this);
    ...
    public void onStartNewChatClick(View view) {
        com.chatapp.chat.ui.activity.SelectUsersActivity.startForResult(this, REQUEST_SELECT_PEOPLE);
    }
        ...
        dialogsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (currentActionMode == null) {
                    com.chatapp.chat.ui.activity.ChatActivity.startForResult(DialogsActivity.this, REQUEST_DIALOG_ID_FOR_UPDATE, selectedDialog.getDialogId());
                } else {
        ...
        ChatHelper.getInstance().createDialogWithSelectedUsers(selectedUsers,
                new QBEntityCallback<QBChatDialog>() {
                    ...
                    public void onSuccess(QBChatDialog dialog, Bundle args) {
                        ...
                        com.chatapp.chat.ui.activity.ChatActivity.startForResult(DialogsActivity.this, REQUEST_DIALOG_ID_FOR_UPDATE, dialog.getDialogId());
                        ProgressDialogFragment.hide(getSupportFragmentManager());
                    }
