...
import com.chatapp.chat.db.QbUsersDbManager;
import com.chatapp.chat.ui.fragments.AudioConversationFragment;
import com.chatapp.chat.ui.fragments.BaseConversationFragment;
import com.chatapp.chat.ui.fragments.ConversationFragmentCallbackListener;
import com.chatapp.chat.ui.fragments.IncomeCallFragment;
import com.chatapp.chat.ui.fragments.IncomeCallFragmentCallbackListener;
import com.chatapp.chat.ui.fragments.OnCallEventsController;
import com.chatapp.chat.ui.fragments.VideoConversationFragment;
import com.chatapp.chat.utils.Consts;
import com.chatapp.chat.utils.FragmentExecuotr;
import com.chatapp.chat.utils.PermissionsChecker;
import com.chatapp.chat.utils.QBEntityCallbackImpl;
import com.chatapp.chat.utils.QBResRequestExecutor;
import com.chatapp.chat.utils.RingtonePlayer;
import com.chatapp.chat.utils.SettingsUtil;
import com.chatapp.chat.utils.UsersUtils;
...
//            we have already currentSession == null, so it's no reason to do further initialization
    ...
    private void startLoadAbsentUsers() {
        ...
        if (!idsUsersNeedLoad.isEmpty()) {
            new QBResRequestExecutor().loadUsersByIds(idsUsersNeedLoad, new QBEntityCallbackImpl<ArrayList<QBUser>>() {
                @Override
